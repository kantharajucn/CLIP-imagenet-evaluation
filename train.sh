...
singularity exec --nv --bind /scratch_local/ docker://lukasschott/ifr:v8 python3 train.py /scratch_local/datasets/ImageNet2012 -a resnet50 --dist-url 'tcp://127.0.0.1:1405' --dist-backend 'nccl' --multiprocessing-distributed --world-size 1 --rank 0 --workers 16 --label-type soft_labels 
